...
const ViewAllMenu = () => {
  ...
  useEffect(() => {
    if (kitchenMenu) setDatas([...kitchenMenu]);
  }, [kitchenMenu]);
  ...
  const initialState = { hiddenColumns: "image" };
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
