...
const AddInventory = () => {
  ...
  const { isadded:isAdded, error, loading } = useSelector(
        ...
        <div className="max-w-4xl mx-auto py-8">
          <div className="p-4 w-full flex flex-col">
            <div className="w-full mb-8">
              <h1 className="text-2xl font-medium mb-2">Add Inventory</h1>
            </div>
              ...
              >
                ...
                <div className="w-full sm:w-[49%] mb-6 relative">
                  <select
                    className="rounded w-full outline-none border border-gray-300 p-2 focus:border-black"
                    onChange={onchange}
                    name="isOnlyInventoryItem"
                    value={inputs.isOnlyInventoryItem}
                  >
                    <option value={""}>Is Only Inventory Item</option>
                    <option value={true}>Yes</option>
                ...
                <div className="w-full mb-6 relative">
                  <textarea
                    className="rounded w-full outline-none border border-gray-300 p-2 focus:border-black"
                    placeholder="Preparation desc"
                    name="menuPreparationDescription"
                    onChange={onchange}
                    value={inputs.menuPreparationDescription}
                  ></textarea>
                </div>
